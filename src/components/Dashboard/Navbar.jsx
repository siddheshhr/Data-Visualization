        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="input-box">
            <input
              ...
              name="search-form"
              id="search-form"
              className="search-input px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:border-blue-500 dark:border-gray-600 dark:focus:border-blue-500"
          ...
          <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div className="main">
              <ProfileImage name="Siddhesh Raskar" />
            </div>
            <button
